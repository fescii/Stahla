...
```
**Instructions:**
1.  Update the `app/core/config.py` file with this content.
2.  Add your actual Bland.ai API key to your `.env` file:
    ```
    # .env file
    HUBSPOT_API_KEY=your-real-hubspot-api-key-xxxx-xxxx-xxxx-xxxx
    BLAND_API_KEY=your-real-bland-api-key-yyyy-yyyy-yyyy-yyyy
