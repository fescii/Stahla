export default class QuotesOldest extends HTMLElement {
  ...
  getSVGIcon = (type) => {
    const icons = {
      ...
      vintage: `<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  getHeader = () => {
    return /* html */ `
      <div class="header">
        <h1>Oldest Quotes</h1>
        <p class="subtitle">Historical quotes ordered by creation date (oldest first)</p>
      </div>
    `;
  };
  ...
  getQuoteRow = (quote, index) => {
    ...
    const vintageBadge = this.getVintageBadge(quote.created_at);
  ...
  getVintageBadge = (dateString) => {
    ...
    if (diffDays > 365) {
      return /* html */ `
        <div class="vintage-badge vintage">
          ${this.getSVGIcon('vintage')}
          <span class="vintage-text">Vintage</span>
        </div>
      `;
    } else if (diffDays > 180) {
      return /* html */ `
        <div class="vintage-badge historic">
          ${this.getSVGIcon('vintage')}
          <span class="vintage-text">Historic</span>
        </div>
      `;
    } else if (diffDays > 90) {
      return /* html */ `
        <div class="vintage-badge archive">
          ${this.getSVGIcon('vintage')}
          <span class="vintage-text">Archive</span>
        </div>
      `;
    }
  ...
  getValueTier = (amount) => {
    ...
    if (amount >= 5000) return 'High Value';
    if (amount >= 2500) return 'Standard';
    return 'Basic';
  };
  ...
  getEmptyMessage = () => {
    return /* html */ `
      <div class="empty-state">
        <h2>No Historical Quotes</h2>
        <p>There are no old quotes to display at this time.</p>
      </div>
    `;
  };
  ...
  getStyles = () => {
    return /* html */ `
      <style>
        ...
        .vintage-badge.historic {
          background: var(--gray-color);
          color: var(--white-color);
        }

        .vintage-badge.archive {
          background: var(--accent-color);
          color: var(--white-color);
        }
