...
class ClassificationInput(BaseModel):
  ...
  email: Optional[EmailStr] = Field(
      None, description="Prospect's email address")
  ...
  lead_type_guess: Optional[str] = Field(
      None, description="Initial guess or statement about why they are contacting (e.g., 'Event', 'Construction')")
  ...
  event_location_description: Optional[str] = Field(
      None, description="Delivery address or general location description")
  ...
  start_date: Optional[str] = Field(
      None, description="Ideal delivery/start date")  # Consider date type
  end_date: Optional[str] = Field(
      None, description="Ideal pickup/end date")  # Consider date type
  ...
  power_cord_ramps_needed: Optional[bool] = Field(
      None, description="Are cord ramps needed for power?")
  generator_needed: Optional[bool] = Field(
      None, description="Is a generator needed?")
  ...
  water_hose_ramps_needed: Optional[bool] = Field(
      None, description="Are hose ramps needed for water?")

  # Other
  budget_mentioned: Optional[str] = Field(
      None, description="Any budget information provided")  # Use str for flexibility
