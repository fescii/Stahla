...
from app.services.quote.quote import (
    QuoteService,
    get_quote_service,
...
async def test_location_service(
    ...
    try:
        ...
        branch_info, distance = await location_service.get_branch_and_distance(
...
async def test_quote_service(
    ...
    if error_msg:
        return GenericResponse.error(
            ...
            details=error_msg,
            status_code=500 if not isinstance(ve, ValueError) else 400,
