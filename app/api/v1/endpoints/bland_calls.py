...
@router.post("/initiate", response_model=GenericResponse[BlandApiResult], status_code=202) # Updated response_model
async def initiate_bland_call(
    ...
    try:
        ...
        return GenericResponse(data=api_result, status_code=202) # Wrapped in GenericResponse
    except Exception as e:
        logfire.error(f"API: Unexpected error initiating call for {contact_id}: {e}", exc_info=True)
        return GenericResponse.error(message="An unexpected error occurred during call initiation.", details=str(e), status_code=500)


@router.post("/retry/{contact_id}", response_model=GenericResponse[BlandApiResult], status_code=202) # Updated response_model
async def retry_bland_call(
    ...
    try:
        ...
        logfire.error(f"API: Unexpected error retrying call for {contact_id}: {e}", exc_info=True)
        return GenericResponse.error(message="An unexpected error occurred during call retry.", details=str(e), status_code=500)


@router.get("/stats", response_model=GenericResponse[BlandCallStats]) # Updated response_model
async def get_call_stats(
    ...
    try:
        ...
        logfire.error(f"API: Unexpected error getting call stats: {e}", exc_info=True)
...
@router.get("/logs", response_model=GenericResponse[PaginatedBlandCallResponse]) # Updated response_model
async def list_all_bland_calls(
    ...
    try:
        ...
        logfire.error(f"API: Unexpected error listing all bland calls: {e}", exc_info=True)
...
@router.get("/logs/failed", response_model=GenericResponse[PaginatedBlandCallResponse]) # Updated response_model
async def list_failed_bland_calls(
    ...
    try:
        ...
        logfire.error(f"API: Unexpected error listing failed bland calls: {e}", exc_info=True)
...
@router.get("/logs/completed", response_model=GenericResponse[PaginatedBlandCallResponse]) # Updated response_model
async def list_completed_bland_calls(
    ...
    try:
        ...
        logfire.error(f"API: Unexpected error listing completed bland calls: {e}", exc_info=True)
