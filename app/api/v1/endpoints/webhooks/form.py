...
class FormWebhookResponseData(BaseModel):
    status: str
    message: str
    classification_result: Optional[Any] = None  # Using Any for now, can be more specific
    hubspot_update_status: Optional[str] = None


@router.post("/form", summary="Process Form Submissions", response_model=GenericResponse[FormWebhookResponseData])  # Updated response_model
