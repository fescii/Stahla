...
echo "   • Removed duplicate app folder from fly-deployment"
...
echo "   • fly-deployment/Dockerfile - Multi-service container"
echo "   • fly-deployment/fly.toml - Fly.io configuration"
echo "   • fly-deployment/set-secrets.sh - Environment variable management"
echo
